# Cost Management for Security Component
# Tracks spending for Key Vault, identities, and security services

# Component-specific budget for security resources
resource "azurerm_consumption_budget_resource_group" "security_budget" {
